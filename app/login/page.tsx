...
function LoginContent() {
  ...
  async function handleGitHubSignIn() {
    ...
    // On success, signInWithOAuth navigates away — no need to reset loading
  }
    ...
    <div className="mx-auto max-w-md px-4 py-20">
      ...
      <div className="mt-8 space-y-4">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-xl bg-[#24292f] px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#24292f]/90 disabled:opacity-60"
        >
          {githubLoading ? (
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-semibold text-gray-700 shadow-sm transition-colors hover:bg-gray-50 disabled:opacity-60"
        >
          {googleLoading ? (
